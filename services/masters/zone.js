...
exports.validate = function () {
    return [
        body('ZONE_NAME', 'parameter missing').exists(),
...
exports.get = (req, res) => {
    ...
    (req.body.searchFilter && req.body.searchFilter != ' ' ? filter += ` AND (ZONE_NAME like '%${req.body.searchFilter}%')  ` : '');
